...
async def start(update: Update, context: CallbackContext):
    await update.message.reply_text("Привет! Меня зовут Cobalt, я создан для игры Удивительные Питомцы на сайте mpets.mobi, благодаря мне ты можешь\n"
                                    "поставить своего питомца (а может и несколько) на 'прокачку', чтобы не приходилось каждый день заходить в игру.\n"
